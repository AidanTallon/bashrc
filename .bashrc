...
# Include git parse type function
source $HOME/.git_status_in_prompt.sh

# Sets the shell prompt to "DIRECTORY [- GIT_BRANCH]\n→"
export PS1='\[\033[36m\]\w $(git branch &>/dev/null; if [ $? -eq 0 ]; then \
echo "\[\033[34m\]- $(gitParseStatus)\[\033[38;5;184m\]$(git branch | grep ^*|sed s/\*\ //)"; fi)\[\033[32m\]\n→ \[\033[00m\]'
...
# ssh into pi alias
alias pi-connect='ssh pi@192.168.0.31'
